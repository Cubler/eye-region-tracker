window.onload = function() {
    ...
    function sendDataToServer(currentRevolPostion){
    	...
    	$.ajax({
    		...
    		error: function(exception){
    			console.log("Image sent Exception: " + exception);
    		}
    	}).done(function(msg){
        	// Once Data is sent run the model
        	//window.location.href = "http://152.2.129.136:8080";
        	$.ajax({
        		type: "GET",
        		//url: "https://comp158.cs.unc.edu:8080/model",
                url: "https://localhost:3000/model",
        		success: function(coords){
    			    ...
    			    console.log("RunModel Exception: " + exception);
    		    }
    		})
        });
    }
    ...
    function drawCircle(currentPercent){
        ...
        context.clearRect(0,0,xstart+r+ptSize, ystart+r+ptSize);
        context.beginPath();
        context.arc(x+xstart,y+ystart,ptSize,0,2*Math.PI);
        context.fill();
